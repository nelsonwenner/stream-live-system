    ...
    <div className="list">
      {
        lives.map(live => (
          <div className="card" key={live.id}>
            ...
            <div className="create-link-live"> <a target="_blank" href={`http://localhost:4000/broadcast/${live.slug}`}>create live</a> </div>
            <div className="invite-live"> <a target="_blank" href={`http://localhost:4000/viewer/${live.slug}`}>invite</a> </div>
