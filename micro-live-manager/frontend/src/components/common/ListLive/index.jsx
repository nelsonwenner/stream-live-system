    ...
    <div>
      {
        lives.map((live, index) => (
          <div className="card" key={index}>
            ...
            <div className="create-link-live effect-in" data-label="CREATE LIVE"> <a target="_blank" rel="noopener noreferrer" href={`http://localhost:4000/broadcast/${live.slug}`}>create live</a> </div>
